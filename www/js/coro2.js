...
// variables globales y textos para toda la aplicación
	...
	//	console.log(ultimoCanto); // eliminar
	...
	//		console.log(canto, ordenDeCantos[canto]);
	...
	//	console.log("=====\n",esteCanto, momento, codigoCantoDescargado, localStorage.getItem(esteCanto)); // BORRAR tras desarrollo
